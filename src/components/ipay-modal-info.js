...
class IpayModalInfo extends HTMLElement {
        ...
        <div class="container">
          ...
          <div class="top-section">
            ...
            <div class="header-section">
              ...
              <div class="header-box">
                <p class="subheader-text">Dostępne raty dla osób oraz finansowanie dla firm</p>
              </div>
            </div>
          ...
          <div class="footer-section">
            <button class="footer-cta">
              ...
              <div class="footer-cta-dot">
                <div class="footer-cta-chevron">
                  <svg width="8" height="8" viewBox="0 0 8 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M3 6L5 4L3 2" stroke="#FFFFFF" stroke-width="0.5" stroke-linecap="round" stroke-linejoin="round"/>
                  </svg>
                </div>
...
customElements.define('ipay-modal-info', IpayModalInfo);

// Export for module usage
export { IpayModalInfo };
