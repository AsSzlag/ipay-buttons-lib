...
class IpayButtonLeasingSmallWide extends HTMLElement {
...
customElements.define('ipay-button-leasing-small-wide', IpayButtonLeasingSmallWide);

// Export for module usage
export { IpayButtonLeasingSmallWide };